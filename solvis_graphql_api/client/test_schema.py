...
test_schema -= sgqlc.types.relay.Node
test_schema -= sgqlc.types.relay.PageInfo
...
class QueryRoot(sgqlc.types.Type):
    ...
    inversion_solution = sgqlc.types.Field(
        FilterInversionSolution,
        graphql_name="inversion_solution",
        args=sgqlc.types.ArgDict(
            (
                (
                    "filter",
                    sgqlc.types.Arg(
                        sgqlc.types.non_null(InversionSolutionAnalysisArguments),
                        graphql_name="filter",
                        default=None,
                    ),
                ),
...
# Schema Entry Points
########################################################################
test_schema.query_type = QueryRoot
test_schema.mutation_type = None

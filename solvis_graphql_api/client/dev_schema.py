...
dev_schema = sgqlc.types.Schema()


# Unexport Node/PageInfo, let schema re-declare them
dev_schema -= sgqlc.types.relay.Node
dev_schema -= sgqlc.types.relay.PageInfo
...
class SetOperationEnum(sgqlc.types.Enum):
    __schema__ = dev_schema
    __choices__ = ("DIFFERENCE", "INTERSECTION", "SYMMETRIC_DIFFERENCE", "UNION")
...
class CompositeRuptureSections(sgqlc.types.Type):
    ...
    fault_traces = sgqlc.types.Field(
        JSONString,
        graphql_name="fault_traces",
        args=sgqlc.types.ArgDict(
            (
                (
                    "color_scale",
            ...
            (
                ...
                (
                    ...
                    sgqlc.types.Arg(
                        ...
                        graphql_name="normalization",
                        default=None,
                    ),
                ),
                (
                    "min_value",
                    sgqlc.types.Arg(Float, graphql_name="min_value", default=None),
                ),
                (
                    "max_value",
                    sgqlc.types.Arg(Float, graphql_name="max_value", default=None),
                ),
            )
        ),
    )
...
class CompositeSolution(sgqlc.types.Type):
    __schema__ = dev_schema
    __field_names__ = ("model_id", "fault_systems", "file_url")
    model_id = sgqlc.types.Field(String, graphql_name="model_id")
...
class QueryRoot(sgqlc.types.Type):
    ...
    locations_by_id = sgqlc.types.Field(
        LocationDetailConnection,
        graphql_name="locations_by_id",
        args=sgqlc.types.ArgDict(
            (
                (
                    "location_ids",
    ...
    composite_solution = sgqlc.types.Field(
        CompositeSolution,
        graphql_name="composite_solution",
        args=sgqlc.types.ArgDict(
            (
                (
                    "model_id",
    ...
    composite_rupture_detail = sgqlc.types.Field(
        "CompositeRuptureDetail",
        graphql_name="composite_rupture_detail",
        args=sgqlc.types.ArgDict(
            (
                (
                    "filter",
                    sgqlc.types.Arg(
                        sgqlc.types.non_null(CompositeRuptureDetailArgs),
                        graphql_name="filter",
                        default=None,
                    ),
                ),
    ...
    filter_ruptures = sgqlc.types.Field(
        "RuptureDetailConnection",
        graphql_name="filter_ruptures",
        args=sgqlc.types.ArgDict(
            (
                (
                    "filter",
                    sgqlc.types.Arg(
                        sgqlc.types.non_null(FilterRupturesArgsInput),
                        graphql_name="filter",
                        default=None,
                    ),
                ),
                (
                    "sortby",
                    sgqlc.types.Arg(
                        sgqlc.types.list_of(SimpleSortRupturesArgs),
                        graphql_name="sortby",
                        default=(),
                    ),
                ),
    ...
    filter_rupture_sections = sgqlc.types.Field(
        CompositeRuptureSections,
        graphql_name="filter_rupture_sections",
        args=sgqlc.types.ArgDict(
            (
                (
                    "filter",
    ...
    get_parent_fault_names = sgqlc.types.Field(
        sgqlc.types.list_of(String),
        graphql_name="get_parent_fault_names",
        args=sgqlc.types.ArgDict(
            (
                (
                    "model_id",
    ...
    get_radii_set = sgqlc.types.Field(
        "RadiiSet",
        graphql_name="get_radii_set",
        args=sgqlc.types.ArgDict(
            (
                (
                    "radii_set_id",
...
class LocationDetail(sgqlc.types.Type, Node):
    ...
    latitude = sgqlc.types.Field(Float, graphql_name="latitude")
    longitude = sgqlc.types.Field(Float, graphql_name="longitude")
    radius_geojson = sgqlc.types.Field(
        JSONString,
        graphql_name="radius_geojson",
        args=sgqlc.types.ArgDict(
            (
                (
                    "radius_km",
...
# Schema Entry Points
########################################################################
dev_schema.query_type = QueryRoot
dev_schema.mutation_type = None
dev_schema.subscription_type = None

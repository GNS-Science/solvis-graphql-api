...
class QueryRoot(sgqlc.types.Type):
    __schema__ = dev_schema
    __field_names__ = ('color_scale', 'node', 'about', 'locations_by_id', 'composite_solution', 'composite_rupture_detail', 'filter_ruptures', 'filter_rupture_sections', 'get_parent_fault_names', 'get_radii_set', 'get_radii_sets', 'get_location', 'get_locations', 'get_location_list', 'get_location_lists')
    color_scale = sgqlc.types.Field(ColorScale, graphql_name='color_scale', args=sgqlc.types.ArgDict((
        ('name', sgqlc.types.Arg(String, graphql_name='name', default=None)),
        ('min_value', sgqlc.types.Arg(Float, graphql_name='min_value', default=None)),
        ('max_value', sgqlc.types.Arg(Float, graphql_name='max_value', default=None)),
